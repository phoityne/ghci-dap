...
--  , module GHC.Types.Breakpoint
  ...
  , parseName
  , fls2fs
  -- , isNothingResumeBreakInfo
  -- , isJustExecBreakBreakInfo
) where
...
-- |
--
-- isNothingResumeBreakInfo:: Resume -> Bool
-- isNothingResumeBreakInfo = isNothing . resumeBreakpointId

-- |
--
-- isJustExecBreakBreakInfo:: ExecResult -> Bool
-- isJustExecBreakBreakInfo = isJust . breakPointId
